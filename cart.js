...
function addtocart() {
  ...
  for (let list of productList) {
    ...
    itemList =
      itemList +
      "<tr><td>" + count + "</td><td>" + list.productName + "</td><td>" + list.Price + "</td><td>" + list.Quantity + "</td><td>" + total + "</td><td>" + `<button type="button" onclick="deleteCartData(${count - 1})"> <img src="images/delete.png" alt="show image"> </button>` + "</td>";
    count++;
    sum = sum + total;
    console.log(sum);
    console.log(count - 1);
